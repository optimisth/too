...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { address: @info.address, email: @info.email, home: @info.home, website: @info.website } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { address: @info.address, email: @info.email, home: @info.home, website: @info.website } }
