...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { avatar: @picture.avatar, work_id: @picture.work_id } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { avatar: @picture.avatar, work_id: @picture.work_id } }
